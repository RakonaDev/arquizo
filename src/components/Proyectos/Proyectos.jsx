      ...
      <div className="d-flex" id="proyectos">
        ...
        <article className="proyectos-container d-flex">
          ...
          <div className="description-proyecto-container">
            <p className="fs-5 text-justify corbel-bold">
              Descubre nuestros proyectos más recientes en saneamiento físico
              legal, diseño arquitectónico y diseño de interiores, donde
              aplicamos nuestra experiencia y compromiso con la excelencia.
            </p>
          </div>
        </article>
      </div>
